...
<body>
  <!-- Start of header section / navbar  -->
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#offers">Offers</a></li>
          <li><a class="nav-link scrollto" href="#companies">Companies</a></li>
          <li><a class="nav-link scrollto" href="#Interns">Interns</a></li>
...
>>>>>>> 756ea0bed142f9d00678e0ae60c027c8cc2c9079
  ...
  <main id="main">
  <input id="search" type="text" oninput="searchOffers(document.getElementById('search').value ,1)">
